...
// 	int a = 500;
// 	int b = 500;
// 	gen->arm= mlx_xpm_file_to_image(gen->mlx_data->mlx_ptr, "./imgs/arm_placeholder.xpm", &a, &b);
// 	mlx_put_image_to_window(gen->mlx_data->mlx_ptr, gen->mlx_data->win_ptr, arm, 0, 0);
// 	mlx_destroy_image(gen->mlx_data->mlx_ptr, arm);
// 	return (0);
// }
// int	start_window(void)
// {
...
// 	if (mlx_data_init())
// 		return (1);
// 	gen->mlx_data->win_ptr = mlx_new_window(gen->mlx_data->mlx_ptr, 1600, 1000,
// 			"salve");
// 	if (!gen->mlx_data->win_ptr)
// 		return (1);
// 	mlx_key_hook(gen->mlx_data->win_ptr, handle_exit, NULL);
